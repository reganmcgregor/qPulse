<div class="modal fade" id="addFineModal" tabindex="-1" role="dialog" aria-labelledby="addFineModalLabel">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="offenceID" class="form-control selectpicker" data-live-search="true">
                            ...
                            <?php
                            //call the get_offence_dropdown() function
                            $result = get_offence_dropdown_by_type(1);
                            //display the offence data in each row using a foreach loop
